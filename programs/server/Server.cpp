...
namespace ServerSetting
{
    ...
    extern const ServerSettingsDouble max_keeper_latency_factor_to_warn;
    extern const ServerSettingsDouble max_keeper_packest_loss_ratio_to_warn;
...
#undef COLLECT_FLAG
    ...
    auto main_config_reloader = std::make_unique<ConfigReloader>(
        ...
        [&](ConfigurationPtr config, bool initial_loading)
        {
            ...
            global_context->setMaxKeeperLatencyFactorToWarn(new_server_settings[ServerSetting::max_keeper_latency_factor_to_warn]);
            global_context->setMaxKeeperPacketsLossRatioToWarn(new_server_settings[ServerSetting::max_keeper_packest_loss_ratio_to_warn]);
