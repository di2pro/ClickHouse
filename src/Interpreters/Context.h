...
public:
    ...
    void setMaxKeeperLatencyFactorToWarn(double max_keeper_latency_factor_to_warn) const;
    void setMaxKeeperPacketsLossRatioToWarn(double max_keeper_packets_loss_ratio_to_warn) const;
    size_t getMaxPendingMutationsToWarn() const;
    size_t getMaxStuckMutationsToWarn() const;
    double getMaxKeeperLatencyFactorToWarn() const;
    double getMaxKeeperPacketsLossRatioToWarn() const;
