...
struct ContextSharedPart : boost::noncopyable
{
    ...
    double max_keeper_latency_factor_to_warn = 5.0; // 5x average latency
    double max_keeper_packets_loss_ratio_to_warn = 0.1; // 10% packet loss
...
void Context::setMaxKeeperLatencyFactorToWarn(double max_keeper_latency_factor_to_warn) const
{
    SharedLockGuard lock(shared->mutex);
    shared->max_keeper_latency_factor_to_warn = max_keeper_latency_factor_to_warn;
}

void Context::setMaxKeeperPacketsLossRatioToWarn(double max_keeper_packets_loss_ratio_to_warn) const
{
    SharedLockGuard lock(shared->mutex);
    shared->max_keeper_packets_loss_ratio_to_warn = max_keeper_packets_loss_ratio_to_warn;
}
...
double Context::getMaxKeeperLatencyFactorToWarn() const
{
    SharedLockGuard lock(shared->mutex);
    return shared->max_keeper_latency_factor_to_warn;
}

double Context::getMaxKeeperPacketsLossRatioToWarn() const
{
    SharedLockGuard lock(shared->mutex);
    return shared->max_keeper_packets_loss_ratio_to_warn;
}
